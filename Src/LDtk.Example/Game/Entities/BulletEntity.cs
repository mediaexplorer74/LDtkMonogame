...
namespace GameManager.Entities
{
    public class BulletEntity
    {
        ...
        public BulletEntity(Texture2D texture, ExampleRenderer renderer)
        {
        ...
        public void Draw()
        {
            renderer.SpriteBatch.Draw(texture, Position, new Rectangle(16 * 4, 0, 16, 16), 
                Color.White, 0, new Vector2(0, .5f), Vector2.One, (SpriteEffects)(Flip ? 1 : 0), 0);
