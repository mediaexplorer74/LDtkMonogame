...
namespace GameManager
{
    public class Game1 : Game
    {
        ...
        /*readonly*/ static GraphicsDeviceManager graphics;
        float pixelScale = 1f;
        ...
        protected override void Initialize()
        {
            ...
            spriteSheet = Texture2D.FromFile(
                GraphicsDevice, System.IO.Path.Combine(System.IO.Path.GetDirectoryName(file.FilePath),
                "Characters.png"));*/
